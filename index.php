...
<head>
    ...
    <title>Login – Harini Aquarium & Fish Shop</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-5 col-lg-4">
                ...
                <div class="text-center text-white mb-3">
                    <i class="fas fa-water fish-icon mb-2 d-block"></i>
                    <h3 class="fw-bold mb-0">Harini Aquarium</h3>
                    <p class="text-light small mb-0">Fish &amp; Aquarium Shop</p>
                ...
                <div class="card login-card">
                    ...
                    <div class="card-footer bg-light px-4 py-3">
                        <p class="text-muted text-center mb-2" style="font-size:0.8rem;">
                            <i class="fas fa-info-circle me-1"></i><strong>Default Login Credentials</strong>
                        </p>
                        <div class="credential-box admin-cred">
                            <span class="badge bg-danger badge-role me-1">Admin</span>
                            <small><strong>Username:</strong> harini &nbsp;|&nbsp; <strong>Password:</strong> harini@123</small>
                        </div>
                        <div class="credential-box user-cred">
                            <span class="badge bg-success badge-role me-1">Customer</span>
                            <small><strong>Username:</strong> demo &nbsp;|&nbsp; <strong>Password:</strong> demo@123</small>
                        </div>
                    </div>
                </div>
